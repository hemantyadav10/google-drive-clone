    ...
    >
      ...
      >
        <div
          ...
          className="flex size-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:shadow-none group-data-[variant=floating]:ring-0 group-data-[variant=floating]:ring-sidebar-border"
        >
          {children}
        </div>
      </div>
